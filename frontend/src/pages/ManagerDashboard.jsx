  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between px-4 py-2.5 border-b border-gray-100">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-1 px-2.5 py-1 text-xs font-semibold text-gray-600 bg-white hover:bg-gray-50 border border-gray-300 rounded-lg transition-colors"
              >
                📥 Import Tasks
              </button>
            </div>
      ...
      <TaskImportModal
        ...
        onImported={() => { setImportOpen(false); fetchData(); toast.success('Tasks imported successfully!'); }}
        isManager={true}
      />
